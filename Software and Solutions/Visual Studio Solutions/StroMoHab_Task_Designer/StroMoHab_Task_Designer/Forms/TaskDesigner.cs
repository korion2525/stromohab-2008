...
namespace StroMoHab_Task_Designer.Forms
{
    ...
    public partial class TaskDesigner : Form
    {
        ...
        private void saveTaskToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            //}
            //else
            //    MessageBox.Show("Cannot modify the current task.", "Playback mode enabled.", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        ...
        {
            const string DEMO_FILE_PATH = @"E:\StromohabDemo\demoTask.smht";

            FileStream fs = new FileStream(DEMO_FILE_PATH, FileMode.Create);
            BinaryFormatter bFormatter = new BinaryFormatter();
            bFormatter.Serialize(fs, m_objectsToDraw.ObjectsToDraw);
            fs.Close();
        ...
        private void btnReloadTaskDesigner_Click(object sender, EventArgs e)
        {
            Process.Start(
                @"E:\Mat\Documents\Working_Copy\Software and Solutions\Visual Studio Solutions\StroMoHab_Task_Designer\StroMoHab_Task_Designer\bin\Debug\StroMoHab_Task_Designer.exe");
